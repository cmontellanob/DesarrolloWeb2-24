...
<table>
    <tr>
        <th>Fotografia</th>
        <th><a href="read.php?ordenar=nombres<?php echo $buscar?>">Nombres</a></th>
        <th><a href="read.php?ordenar=apellidos<?php echo $buscar?>">Apellidos</a></th>
        <th><a href="read.php?ordenar=carnet<?php echo $buscar?>">Carnet</a></th>
        <th><a href="read.php?ordenar=sexo<?php echo $buscar?>">Sexo</a></th>
        <th><a href="read.php?ordenar=fecha_nacimiento<?php echo $buscar?>">Fecha de nacimiento</a></th>
        <th><a href="read.php?ordenar=direccion<?php echo $buscar?>">Direccion</a></th>
        <td><a href="read.php?ordenar=numero_mesa<?php echo $buscar?>">Mesa</a></th>
        <th>Operaciones</th>
    </tr>
